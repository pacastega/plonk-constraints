...
{-@ sha256_4 :: GlobalStore BigPF ({v:DSL BigPF | typed v (TVec TBool)}) @-}
sha256_4 :: GlobalStore BigPF (DSL BigPF)
sha256_4 = sha256 (replicate 64 'a')

{-@ sha256_5 :: GlobalStore BigPF ({v:DSL BigPF | typed v (TVec TBool)}) @-}
sha256_5 :: GlobalStore BigPF (DSL BigPF)
sha256_5 = sha256 (replicate (2*64) 'a')

{-@ sha256_6 :: GlobalStore BigPF ({v:DSL BigPF | typed v (TVec TBool)}) @-}
sha256_6 :: GlobalStore BigPF (DSL BigPF)
sha256_6 = sha256 (replicate (3*64) 'a')

{-@ sha256_7 :: GlobalStore BigPF ({v:DSL BigPF | typed v (TVec TBool)}) @-}
