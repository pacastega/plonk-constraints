...
notGate _ [a, c] =
  [([Wire a, Free,   Wire c], [-1,  0, -1,  0,  1]), -- 1.
   ([Wire a, Wire a, Free],   [-1,  0,  0,  1,  0])] -- 2.
...
andGate _ [a,b,c] =
  [([Wire a, Wire b, Wire c], [ 0,  0, -1,  1,  0]), -- 1.
   ([Wire a, Wire a, Free],   [-1,  0,  0,  1,  0]), -- 2.
   ([Wire b, Wire b, Free],   [-1,  0,  0,  1,  0])] -- 3.
  --      a       b    c       qL  qR  qO  qM  qC
...
orGate _ [a,b,c] =
  [([Wire a, Wire b, Wire c], [ 1,  1, -1, -1,  0]), -- 1.
   ([Wire a, Wire a, Free],   [-1,  0,  0,  1,  0]), -- 2.
   ([Wire b, Wire b, Free],   [-1,  0,  0,  1,  0])] -- 3.
  --      a       b    c       qL  qR  qO  qM  qC
...
xorGate _ [a,b,c] =
  [([Wire a, Wire b, Wire c], [ 1,  1, -1, -2,  0]), -- 1.
   ([Wire a, Wire a, Free],   [-1,  0,  0,  1,  0]), -- 2.
   ([Wire b, Wire b, Free],   [-1,  0,  0,  1,  0])] -- 3.
  --      a       b    c       qL  qR  qO  qM  qC
...
unsafeNotGate _ [a, c] = [([Wire a, Free, Wire c], [-1,  0, -1,  0,  1])]
                         --      a    b        c    qL  qR  qO  qM  qC
...
unsafeAndGate _ [a,b,c] = [([Wire a, Wire b, Wire c], [ 0,  0, -1,  1,  0])]
                          --      a       b       c    qL  qR  qO  qM  qC
...
unsafeOrGate _ [a,b,c] = [([Wire a, Wire b, Wire c], [ 1,  1, -1, -1,  0])]
                         --      a       b       c    qL  qR  qO  qM  qC
...
unsafeXorGate _ [a,b,c] = [([Wire a, Wire b, Wire c], [ 1,  1, -1, -2,  0])]
                          --      a       b       c    qL  qR  qO  qM  qC
